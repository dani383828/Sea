...
async def send_game_reports(update: Update, context: ContextTypes.DEFAULT_TYPE, opponent_name: str, cannons: int, energy: int, opponent_cannons: int):
    ...
    # 100 random battle reports
    battle_reports = [
        "ناخدا، کشتی دشمن از مه بیرون اومد! آماده نبرد شو!",
        "نیروهای دشمن با طناب به کشتی‌مون چنگ زدن! شمشیرها رو آماده کن!",
        "با یه شلیک توپ، عرشه دشمن شعله‌ور شد!",
        "دشمن داره از پهلو نزدیک می‌شه! دفاع رو تقویت کن!",
        "ناخدا، ۳ نفر از خدمه دشمن رو با شمشیر انداختیم تو دریا!",
        "یه موج بزرگ کشتی دشمن رو تکون داد، حالا شانس ماست!",
        "توپچی‌ها شلیک کردن، ۲ نفر از دشمن کشته شدن!",
        "دشمن با یه تخته چوبی داره به کشتی‌مون می‌پره!",
        "ناخدا، یه بمب دودزا از کشتی دشمن اومد، دید کم شده!",
        "با حمله ناگهانی، ۴ نفر از اونا رو از پای درآوردیم!",
        ...
        "دشمن داره فرار می‌کنه، تعقیبشون کنیم!",
        "یه انفجار تو کشتی دشمن، ۵ نفرشون از بین رفتن!",
        "ناخدا، طوفان داره به نفع ما می‌چرخه!",
        "دشمن با چاقو به سمت خدمه‌مون حمله کرد، ۲ نفر کشته شدن!",
        "با شلیک دقیق، دکل دشمن شکسته شد!",
        "نیروهای دشمن دارن تسلیم می‌شن، جلو برو!",
        "ناخدا، یه گروه از اونا با قایق به کشتی‌مون چسبیدن!",
        "با شمشیر هامون، ۶ نفر از اونا رو به زانو درآوردیم!",
        "دشمن داره از دود استفاده می‌کنه، مراقب باش!",
        "یه شلیک توپ، عرشه دشمن رو نابود کرد!",
        "ناخدا، ۴ نفر از خدمه دشمن رو با تفنگ زدیم!",
        "کشتی دشمن داره می‌لرزه، شانس ماست!",
        "دشمن با یه طناب بزرگ داره به کشتی‌مون میاد!",
        "ناخدا، با یه ضربه، ۵ نفر از اونا رو کشتیم!",
        "یه موج، قایق دشمن رو واژگون کرد!",
        "دشمن داره با نیزه حمله می‌کنه، دفاع کن!",
        "با شلیک توپ، ۳ نفر از اونا تو دریا غرق شدن!",
        "ناخدا، یه گروه کوچک از دشمن تو انبار پنهان شدن!",
        "دشمن داره با باروت حمله می‌کنه، عقب‌نشینی کن!",
        ...
        "ناخدا، طوفان داره کشتی دشمن رو نابود می‌کنه!",
        "دشمن داره با شمشیر به سمت ما می‌دوه!",
        "با یه ضربه قوی، ۶ نفر از اونا رو نابود کردیم!",
        ...
        "دشمن داره با دود غلیظ ما رو گیج می‌کنه!",
        "ناخدا، با یه شلیک، دکل دشمن شکست!",
        "دشمن داره با قایق‌های کوچک نزدیک می‌شه!",
        "با شمشیر، ۵ نفر از اونا رو به دریا انداختیم!",
        "ناخدا، یه انفجار تو کشتی دشمن رخ داد!",
        "دشمن داره با چاقو به خدمه‌مون حمله می‌کنه!",
        "با توپ، ۴ نفر از اونا رو نابود کردیم!",
        "ناخدا، طوفان داره به ضرر دشمن می‌چرخه!",
        "دشمن داره با طناب به دکل ما می‌چسبه!",
        "با تبر، ۶ نفر از اونا رو کشتیم!",
        "کشتی دشمن داره می‌شکنه، ادامه بده!",
        "ناخدا، یه تیر آرشه به سینه یکی از اونا خورد!",
        "دشمن با یه بمب دودزا داره ما رو محاصره می‌کنه!",
        "با شلیک، ۵ نفر از خدمه دشمن غرق شدن!",
        "ناخدا، یه موج بزرگ کشتی دشمن رو واژگون کرد!",
        "دشمن داره با نیزه به سمت عرشه میاد!",
        "با شمشیر، ۷ نفر از اونا رو نابود کردیم!",
        "کشتی دشمن داره می‌سوزه، شانس ماست!",
        "ناخدا، یه گروه از اونا تو زیرزمین پنهان شدن!",
        "دشمن با باروت داره به ما حمله می‌کنه!",
        "با تبر، ۴ نفر از اونا رو از پای درآوردیم!",
        "ناخدا، طوفان داره کشتی‌مون رو نجات می‌ده!",
        "دشمن با چاقو داره به خدمه حمله می‌کنه!",
        "با شلیک توپ، ۶ نفر از اونا کشته شدن!",
        "کشتی دشمن داره غرق می‌شه، تعقیب کن!",
        "ناخدا، یه تیر کمان به دکل دشمن خورد!",
        "دشمن با تخته چوب داره به عرشه می‌پره!",
        "با تفنگ، ۵ نفر از اونا رو نابود کردیم!",
        "ناخدا، یه انفجار تو انبار دشمن رخ داد!",
        "دشمن با طناب داره به کشتی‌مون میاد!",
        "با شمشیر، ۸ نفر از اونا رو به دریا انداختیم!",
        "کشتی دشمن داره می‌شکنه، شانس ماست!",
        "ناخدا، طوفان داره به نفع ما می‌چرخه!",
        "دشمن با نیزه داره به سمت ما حمله می‌کنه!",
        "با شلیک، ۴ نفر از خدمه دشمن کشته شدن!",
        "ناخدا، یه موج کشتی دشمن رو نابود کرد!",
        "دشمن داره با دود ما رو گیج می‌کنه!",
        "با تبر، ۶ نفر از اونا رو از بین بردیم!",
        "کشتی دشمن داره می‌سوزه، ادامه بده!",
        "ناخدا، یه تیر آرشه به دشمن برخورد کرد!",
        "دشمن با بمب دودزا داره ما رو محاصره می‌کنه!",
        "با توپ، ۵ نفر از اونا غرق شدن!",
        "ناخدا، طوفان داره دشمن رو نابود می‌کنه!",
        ...
        "با شمشیر، ۶ نفر از اونا رو کشتیم!",
        "ناخدا، یه انفجار تو کشتی دشمن رخ داد!",
        "دشمن با قایق‌های کوچک داره نزدیک می‌شه!",
        "با تبر، ۵ نفر از اونا رو نابود کردیم!",
        "کشتی دشمن داره می‌شکنه، ادامه بده!",
        "ناخدا، طوفان به نفع ماست!",
        "دشمن با نیزه داره به عرشه حمله می‌کنه!",
        "با شلیک، ۴ نفر از اونا کشته شدن!",
        "ناخدا، یه موج بزرگ دشمن رو غرق کرد!",
        "دشمن با دود داره ما رو گیج می‌کنه!",
        "با شمشیر، ۷ نفر از اونا رو از پای درآوردیم!"
    ]
